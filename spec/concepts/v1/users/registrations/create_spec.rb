...
RSpec.describe V1::Users::Registrations::Operation::Create do
  describe 'Success' do
    ...
    it "create new user" do
      op = V1::Users::Registrations::Operation::Create.(params: { email: user.email, password: user.password, password_confirmation: user.password })
  ...
  describe 'Fail' do
    ...
    #   let(:params) { params.merge(password_confirmation: '') }
    #   it "create new user" do
    #     op = V1::Users::Registrations::Operation::Create.(params: params)
    #     expect(op).to be_failure
    #   end
...
#       expect(result[:errors]).to be_eql(nil)
#       p '---------------'
#       p valid_params
#       p result
